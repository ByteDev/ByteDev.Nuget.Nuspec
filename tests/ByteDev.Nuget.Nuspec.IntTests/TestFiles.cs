namespace ByteDev.Nuget.Nuspec.IntTests
{
    public static class TestFiles
    {
        ...
        public static readonly string NoGroupDependencies = BasePath + "NoGroupDependencies.xml";
        public static readonly string NoGroupReferences = BasePath + "NoGroupReferences.xml";
    }
}